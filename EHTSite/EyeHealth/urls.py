...
urlpatterns = [
    ...
    path("<str:type_of_training>/<str:difficulty_level>/", views.display_test, name="display_test"),
    path("<str:type_of_training>/<str:difficulty_level>/<int:task_num>", views.display_task,
         name="display_task"),
    path('<str:type_of_training>/<str:difficulty_level>/<int:task_num>/grade/',
