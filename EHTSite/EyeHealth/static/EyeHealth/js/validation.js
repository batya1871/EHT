...
const btn_def = document.querySelectorAll('.btn-default');
const form_def = document.querySelectorAll('.form-users-css');
if (errorlist.length > 0){
  btn_def[0].classList.remove("btn-margin");
  form_def[0].classList.remove("form-padding-top");
}
