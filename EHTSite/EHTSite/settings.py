"""
Django settings for EHTSite project.
...
Sammer_2002_pg
psql -d EyeHealth_bd -U postgres
...
INSTALLED_APPS = [
    "EyeHealth.apps.EyeHealthConfig",
...
DEBUG = True
WSGI_APPLICATION = 'EHTSite.wsgi.application'
